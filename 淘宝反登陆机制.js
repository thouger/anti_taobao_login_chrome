!function(n,t,r,i,o,a,e,c,u,f,s,l,m,h,v) {
  var p,d=368,g="isg",y=c,b=!!y.addEventListener,w=u.getElementsByTagName("head")[0],z=f.userAgent;
  !function(n) {
    function t() {
    ...
    n.a=t;
    var m=/native code/,h=r.prototype.toString;
  ...
  var _,k=function() {
    ...
    return n.prototype.m=function() {
      for(var n,t=u.cookie,r=[];n=this.j.exec(t);
      )r.push(n[1]);
      return r
    }
  ...
  !function(n) {
    ...
    function r(n) {
      ...
      if(null==t&&(t=.001),!(i.random()>t)) {
        c( {
          code:1,msg:(n+"").substr(0,1e3),pid:"sufeidata",page:l.href.split(/[#?]/)[0],query:l.search.substr(1),hash:l.hash,referrer:u.referrer,title:u.title,ua:f.userAgent,rel:d,c1:a()
        }
  ...
  !function(n) {
    ...
    function e(n) {
      if(tn=n.isTrusted,null==tn&&(tn=!0),b) {
        var r=n.target,o=r.offsetWidth>>1,a=r.offsetHeight>>1;
        if(!(o<10&&a<10)) {
          var e=i.abs(n.offsetX-o),u=i.abs(n.offsetY-a),f=e<2&&u<2;
    ...
    function w() {
      var n=h.availWidth,t=c.outerWidth;
    ...
    var N,Y,$,U=0,Q=0,G=0,F=0,J=0,V=0,Z=!0,K=0,nn=0,tn=!0,rn=!0,on=!1,an=!!y.DeviceOrientationEvent;
  ...
  !function(n) {
    ...
    var T=!0,E=0,M=t(16),L=[r,i,a,e,l],B=[m,h,v,d,g];
    n.T=g,n.U=_;
    var P=f.vendor,q=w.style,R="chrome"in c,W="ActiveXObject"in c,O=p.b(y.WeakMap),S= {
      _13:function() {
  ...
  !function(t) {
    ...
    function i(n,t) {
      switch(t.length) {
        ...
        default:return new n(t[0],t[2],t[3])
      }
  ...
  var E,M=function() {
    ...
    return n.prototype.ja=function() {
      for(var n=this.ia,t=[],r=-1,i=0,o=n.length;i<o;i++)for(var a=this[i],e=n[i],c=r+=e;t[c]=255&a,0!=--e;)--c,a>>=8;
      return t
    }
  ...
  !function(n) {
    function t() {
      for(var n=f.platform,t=0;t<r.length;t++)if(r[t].test(n))return t+1;
      return 0
    }
  ...
  !function(n) {
    ...
    function i(n,r) {
      ...
      o[17]=x.S(),o[18]=x.Q();
      var c=x.L(),u=x.N(),f=x.M(),s=[r,x.K(),n,c,i,!0,f,u];
      n&&a++,o[15]=p.h(s),o[0]=a;
      var l=o.ja(),m=E.la(l);
      return m
    }
    var o=new M([2,2,4,4,4,1,1,4,4,3,2,2,2,2,2,1,2,1,1,1,1]),a=0;
    n.z=r,n.oa=i
  }
  (B||(B= {
  ...
  !function(n) {
    function t(n,t) {
      var r=n.split("."),i=r.length-1,o=r[i];
      if(o in t)return!0;
    ...
    function r(n) {
      ...
      i>5&&(i=5),t=r.pop();
      for(var o=2;o<=i&&(t=r.pop()+"."+t,x.u(t),x.o(n),!(t in j.ba||t in j.ca||t in j.da))&&x.n()!==n;
      o++);
      return t
    }
    function i(n) {
      var t=r(n),i="(^|\\.)"+t.replace(/\./g,"\\.")+"$";
      z=new a(i,"i")
    }
    function e() {
      A=null;
  ...
  !function(n) {
    ...
    function r() {
      T.fa(y,"fetch",function(n) {
        var t=n[0],r=n[1];
        "string"==typeof t&&P.qa(t)&&(r=r|| {
          
        }
        ,r.credentials&&"omit"!==r.credentials||(r.credentials="same-origin"),n[1]=r)
      }
      )
    }
    function i() {
